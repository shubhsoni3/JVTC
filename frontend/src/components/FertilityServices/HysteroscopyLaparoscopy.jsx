          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="cs_blog_details">
                <h2>What is Hysteroscopy Treatment </h2>
                <p>
                  The word Hystero means uterus and the word scopy means to see.
                  So Hysteroscopy means to see inside the uterus. It is not
                  routinely needed by all the women suffering from infertility.
                  Only selected women need this procedure and these include
                  women who have very thin lining of the uterus, woman having
                  fibroid or polyps (abnormal thickening of uterine lining) near
                  the lining of the uterus, women with history of repeated
                  miscarriages or repeated IVF failures to name a few. Your
                  fertility specialist can advise you regarding their need of
                  Hysteroscopy in your case. <br />
                  <br />
                  In this procedure, a very thin tube with a Camera placed at
                  the tip of the tube is put inside the uterus from the vagina.
                  This helps to see the inner part of the uterus and the
                  complete lining of the uterus. It helps in diagnosing any
                  problem which could lead to infertility or miscarriage and
                  simultaneously correct these problems. <br />
                  <br />
                  This procedure can be done as an outpatient procedure without
                  an anesthesia or as an in patient procedure with an aesthesia.
                  There is no cut or stitches in the body and so the patient can
                  start the routine work from the next day itself.
                </p>

                <h2>Types Of Hysteroscopy:</h2>
                <ol>
                  <li>
