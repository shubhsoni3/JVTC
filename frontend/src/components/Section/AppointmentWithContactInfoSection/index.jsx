...
const contactInfo = [
  { title: "Contact Us", subTitle: "+91-7770877117" },
  { title: "Email Us", subTitle: "dr.archanashrivastav@gmail.com" },
  {
    title: "Our Location",
    subTitle:
      "199-A,Jabalpur Fertility Centre,Opposite Madan Mahal Thana , Home Science College Road, Napier Town Jabalpur, 482001, Madhya Pradesh",
  },
];
